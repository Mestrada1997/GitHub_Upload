...
present_value = future_value / (1 + ann_disc_rate/12) ** remaining_months
...
new_remaining_months = new_loan.get("remaining_value")
new_loan_present_value=calculate_present_value(future_value=remaining_months, ann_disc_rate):
...
with open(file=output_path, mode="w") as csvfile:
    csvwriter = csv.writer(csvfile=csvfile, delimiter=",")
